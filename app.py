...
def showWelcomeIntent(resp):
    ...
    myEmail = Email("charlesdavid2711@gmail.com", "charlesdavid531@gmail.com","Product wise sales report","As requested please find attached the product wise sales report",myAttachment)
    myEmail.sendEmail()
