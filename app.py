...
def showWelcomeIntent(resp):
    ...
    myEmail = Email("charlesdavid2711@gmail.com", "cdavid@deloitte.com","Product wise sales report","As requested please find attached the product wise sales report",myAttachment)
    myEmail.sendEmail()
